				...
				<div class="CSSTableGenerator">
					<table>
						...
						<tr>
							...
							<td>
								<a href="http://www.google.com"onclick="MM_openBrWindow('remove.jsp?tc=${myhesap.getTc()}&hesapturu=${myhesap.getHesapturu()}&hesapboyutu=${myhesap.getHesapboyutu()}&miktar=${myhesap.getMiktar()}','google','scrollbars=yes,width=500,height=400'); return false;">
								<img src="image/remove.png" alt="Google" width="32" height="32"  style="border: 0;"></a>
										</td>
						</tr>
