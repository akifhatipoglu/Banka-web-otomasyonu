...
<script type="text/javascript">
 function formkontrol1(form){
	if(form.aranacak.value==""){ alert("Lütfen tablo seçiniz giriniz."); return false;}
	if(form.kelime.value==""){ alert("Lütfen Arama alanını boş bırakmayınız."); return false;}
}
</script>
	<table >
		<tr>
			...
			<form method="post" action="search" name="mysearch" onsubmit="return formkontrol1(document.mysearch)" >
   			 <table>
   			 <tr>	<td>Aranacak tablo :</td><td><select name="aranacak"><option value="tc">tc</option><option value="hesapturu">Hesap Türü</option><option value="hesapboyutu">Hesap Boyutu</option><option value="miktar">Miktar</option></select></td>
    	   	 <td>Aranacak Kelime:</td><td><input type="text" name="kelime" ></input></td>
